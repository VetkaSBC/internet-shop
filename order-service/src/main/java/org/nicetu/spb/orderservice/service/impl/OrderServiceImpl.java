...
public class OrderServiceImpl implements OrderService {
    ...
    public Mono<OrderDto> save(final OrderDto orderDto) {
        ...
        return Mono.fromSupplier(() -> OrderMappingHelper.mapToDto(orderRepository.save(OrderMappingHelper.mapToEntity(orderDto))))
                .onErrorResume(throwable -> {
    ...
    public Mono<OrderDto> update(final OrderDto orderDto) {
        ...
        return Mono.fromSupplier(() -> orderRepository.save(OrderMappingHelper.mapToEntity(orderDto)))
                .map(OrderMappingHelper::mapToDto);
    }
    ...
    public Mono<OrderDto> update(final Integer orderId, final OrderDto orderDto) {
        ...
        return findById(orderId).flatMap(existingOrderDto -> {
                    ...
                    return Mono.fromSupplier(() -> orderRepository.save(OrderMappingHelper.mapToEntity(existingOrderDto)))
                            .map(OrderMappingHelper::mapToDto);
                })
